...
from nvtx.plugins.common.logger_utils import StdOutFormatter
from nvtx.plugins.common.metaclasses import SingletonMetaClass
...
class Logger(object):
    ...
    def _define_logger(self):
        ...
        with self._logger_lock:
            ...
            try:
                ...
                self._logger = _logging.getLogger('nvtx-plugins')
    ...
    def reset_stream_handler(self):
        ...
        self._handlers["stream_stdout"].setFormatter(StdOutFormatter())
        self._logger.addHandler(self._handlers["stream_stdout"])

        try:
            self._handlers["stream_stderr"].setFormatter(StdOutFormatter())
